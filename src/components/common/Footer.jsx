    ...
    return (
        <footer className="footer p-10 bg-base-300 text-base-content ">
            <aside>
                ...
                <p className="mt-4">Copyright © 2024 - All right reserved by <Link to="/"><span className="hover:text-cyan-800 font-bold">TOY CARS  HUT</span></Link> Industries Ltd</p>
            </aside>
            <nav>
